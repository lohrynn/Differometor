...
#SBATCH --time=0-01:50            # Allowed runtime in D-HH:MM
...
# Compute Phase
srun python examples/voyager_genetic.py   # srun will automatically pickup the configuration defined via `#SBATCH` and `sbatch` command line arguments
